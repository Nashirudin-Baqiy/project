...
public class RestPendaftaranBooking {
    ...
    @SerializedName("data")
    @Expose
    private List<PendaftaranBooking> data = null;
    ...
    public List<PendaftaranBooking> getData() {
        return data;
    }

    public void setData(List<PendaftaranBooking> data) {
        this.data = data;
    }
