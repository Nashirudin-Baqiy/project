...
import id.co.rsnasionaldiponegoro.epublic.Views.Activity.Telemedicine.Pendaftaran.ActivityTMKonsulAddDokter;

/**
 * Created by xsanz on 24-Jun-2020.
 */

public class AdapterTMPendPoli extends RecyclerView.Adapter<AdapterTMPendPoli.MyViewHolder> {
    private ArrayList<PendaftaranPoli> pendaftaranPolis = new ArrayList<>();
    private Context context;
    private LayoutInflater inflater;
    private Session session;

    public AdapterTMPendPoli(Context context, ArrayList<PendaftaranPoli> pendaftaranPolis){
    ...
    @Override
    public AdapterTMPendPoli.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = inflater.inflate(R.layout.adapter_pend_poli, parent, false);
        return new AdapterTMPendPoli.MyViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(AdapterTMPendPoli.MyViewHolder holder, int position) {
        ...
        private MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(context, ActivityTMKonsulAddDokter.class);
