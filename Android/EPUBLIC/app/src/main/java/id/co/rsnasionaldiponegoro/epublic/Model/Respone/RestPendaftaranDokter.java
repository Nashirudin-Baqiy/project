...
public class RestPendaftaranDokter {
    ...
    @SerializedName("data")
    @Expose
    private List<PendaftaranDokter> data = null;
    ...
    public List<PendaftaranDokter> getData() {
        return data;
    }

    public void setData(List<PendaftaranDokter> data) {
        this.data = data;
    }
}
