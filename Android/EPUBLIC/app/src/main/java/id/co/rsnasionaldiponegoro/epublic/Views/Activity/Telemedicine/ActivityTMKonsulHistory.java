...
import id.co.rsnasionaldiponegoro.epublic.Views.Adapter.AdapterTMKonsulKu;
import id.co.rsnasionaldiponegoro.epublic.Views.InterfaceViews.ViewsPendaftaran;

public class ActivityTMKonsulHistory extends AppCompatActivity implements ViewsPendaftaran {
    ...
    private AdapterTMKonsulKu adapterBookingBaru;
    private RecyclerView recyclerView;
    private TextView text_nodata;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tmkonsul_history);
        init();
    }
    ...
    void init(){
        ...
        adapterBookingBaru    = new AdapterTMKonsulKu(this,pendaftaranBookings);
...
//        loading.show();
        ...
        dataInfo.listPendaftaranH(this,this,query);
    }
}
