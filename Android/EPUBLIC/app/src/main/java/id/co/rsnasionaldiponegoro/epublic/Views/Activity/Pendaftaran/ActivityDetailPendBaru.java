...
public class ActivityDetailPendBaru extends AppCompatActivity implements View.OnClickListener,ViewsPendDetail,ViewsPendBatal {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_pend_baru);
        init();
    }
    ...
    private void init(){
        ...
        queryLanjut.put("kodePasien",""+getIntent().getExtras().getString("kodePasien"));
...
//        headline_text.setText(""+session.getSessionUserPend().getaLAMAT());
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(session.getSessionBoolean("backDaftar",false)){
//                    startActivity(new Intent(ActivityDetailPendBaru.this,ActivityPendHome.class));
                    Intent intent=new Intent(ActivityDetailPendBaru.this,ActivityMain.class);
...
//        }
        ...
        String[] tgllhrs=rest.getData().get(0).getFAPTGLLAHIR().split(" ");
        tv_norm.setText(""+getIntent().getExtras().getString("kodePasien"));
        tv_tgllhr.setText(""+tgllhrs[0]);
        tv_nama.setText(""+rest.getData().get(0).getFAPNAMAPASIEN());

        headline_text.setText(""+rest.getData().get(0).getFAPALAMAT());
        headline_text.setSelected(true);
